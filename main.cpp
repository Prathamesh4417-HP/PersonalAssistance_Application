...
void greetings()
{
    ...
    if (time->tm_hour < 12)
    {
        cout << "Good Morning Master Stricas" << endl;
        string phrase = "Good Morning Master Stricas";
    ...
    {
        cout << "Good Afternoon Master Stricas" << endl;
        string phrase = "Good Afternoon Master Stricas";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
    ...
    {
        cout << "Good Evening Master Stricas" << endl;
        string phrase = "Good Evening Master Stricas";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout << "******************************************************" << endl;
        cout << "| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER STRICAS|" << endl;
        cout << "******************************************************" << endl
             << endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER STRICAS";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if (password == "prathamesh")
        {
            ...
            do
            {
                cout << "\n<**********************************************************************************************>\n\n";
                cout << endl
                     << "How can i help you Master STRICAS...." << endl
                     << endl;

                string phrase = "How can i help you Master STRICAS";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout << "Hello Master STRICAS....." << endl;
                    string phrase = "Hello Master STRICAS";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout << "I'm a personal assistant created by Master STRICAS !!!" << endl;
                    string phrase = "I'm a personal assistant created by Master STRICAS !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout << "Good Bye Master STRICAS, see you soon!" << endl;
                    string phrase = "Good Bye Master STRICAS, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
